...
class TestMarkovChain(unittest.TestCase):
    ...
    def test_init(self):
        model = MC(self.edges, start_state=0)
    ...
    @patch("pgmpy.models.MarkovChain.reset_weights")
    ...
    def test_check_markov_chain_false_2(self):
        model = MC([(1, 2, 0.4), (1, 1, 0.5), (2, 2, 1)])
        self.assertFalse(model.check_markov_chain())
